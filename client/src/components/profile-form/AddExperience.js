...
import {addExpriance} from '../../action/profile'
import { Link,useNavigate  } from 'react-router-dom'

const AddExperience = ({addExpriance,history})=> {
  ...
  return (
    <Fragment>
      ...
      <form className="form" onSubmit={(e) => {
          e.preventDefault();
          addExpriance(formData).then(() => navigate('/dashboard'));
        }}>
...
addExpriance:PropTypes.func.isRequired
}

export default connect(null,{addExpriance})(AddExperience);
